...
class Blockchain:
    ...
    def valid_proof(proofA, proofB):
        ...
        ## for a value of x that have us a certain magic value for <guess>. The second
    ...
    def valid_chain(chain):
        '''
        Params:
          chain <list>: List of blocks to validate (Blockchain.chain)
        Returns:
          Return True if given chain is a valid chain.
        '''
